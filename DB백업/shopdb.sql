...
INSERT INTO `deletedMemberTBL` VALUES ('Dang','당탕이','경기 부천시 중동','2022-09-19');
...
/*!50001 VIEW `uv_membertbl` AS select `membertbl`.`memberID` AS `memberID`,`membertbl`.`memberAddress` AS `memberAddress` from `membertbl` */;
...
-- Dump completed on 2022-09-19 23:12:35
